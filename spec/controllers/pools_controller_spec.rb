...
RSpec.describe PoolsController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: pool.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      pool = Pool.create! valid_attributes
      get :edit, params: {id: pool.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {pool: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested pool" do
        pool = Pool.create! valid_attributes
        put :update, params: {id: pool.to_param, pool: new_attributes}, session: valid_session
        pool.reload
      ...
      it "redirects to the pool" do
        pool = Pool.create! valid_attributes
        put :update, params: {id: pool.to_param, pool: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        pool = Pool.create! valid_attributes
        put :update, params: {id: pool.to_param, pool: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested pool" do
      pool = Pool.create! valid_attributes
      expect {
        delete :destroy, params: {id: pool.to_param}, session: valid_session
      }.to change(Pool, :count).by(-1)
    end
